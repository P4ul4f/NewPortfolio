...
export const projects = [
  ...
  {
    id: 2,
    title: "CloudWise Authentication Page",
    name: "CloudWise",
    des: "Designed and implemented a responsive sign-in page for the Cloud-Wise platform using Next.js. Focused on secure authentication flows, intuitive design, and mobile-first accessibility to enhance user experience and data protection.",
    img: "/proj5.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/appwrite.png"],
    link: "https://cloud-wise.vercel.app/sign-in",
  },
  {
    id: 3,
