...
const Footer = () => {
  return (
    <footer className="w-auto h-full" id="contact">
      {/* background grid */}
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center mb-10">
        ...
        <div className="flex items-center md:gap-3 gap-6">
          {socialMedia.map((info) => (
            <div
              key={info.id}
              className="w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300 sm:pt-4"
            >
              <a href={info.link}>
